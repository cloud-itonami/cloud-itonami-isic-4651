# Operator Quickstart — Wholesale of computers, computer peripheral equipment and software

Shortest path from clone to a verified local dry-run for **ISIC 4651** (`cloud-itonami-isic-4651`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4651.git
cd cloud-itonami-isic-4651
```
...
- Blueprint governor key: `tech-export-governor`
- Likely source path: `techtrade.governor.cljc`
